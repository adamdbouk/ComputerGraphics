...
// or callback sintax:   img.forEachPixel( mycallback ); //the callback has to be Color mycallback(Color c) { ... }
	...
	void drawTriangle(Vector3 p1, Vector3 p2, Vector3 p3, Vector2 t1, Vector2 t2, Vector2 t3, Vector3 lv1, Vector3 lv2, Vector3 lv3, Color c, FloatImage* zbuffer, Image* texture, int mode, Light* light, Material* material);
