...
public:
	...
	void drawTriangle(Vector3 p1, Vector3 p2, Vector3 p3, Vector2 t1, Vector2 t2, Vector2 t3, FloatImage* zbuffer, Image* texture, Light* light, Material* material, Vector3 p_w1, Vector3 p_w2, Vector3 p_w3, Vector3 ambient_color, Camera* camera, Image* texture_normals);
	void bresenhamTriangle(int x0, int y0, int x1, int y1, Color c, std::vector<sCelda>& table);
