...
Vector3 Camera::calcLight(Vector3 punt, Vector3 normal, Light* light, Material* material, Vector3 ambient_color) {
	Vector3 ambient_light = Vector3(material->ambient.x * ambient_color.x, material->ambient.y * ambient_color.y, material->ambient.z * ambient_color.z);
	...
	Vector3 light_inten = ambient_light + diffuse + specular;
